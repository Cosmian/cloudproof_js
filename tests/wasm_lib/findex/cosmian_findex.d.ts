...
*/
export function webassembly_search(master_keys: string, label_bytes: Uint8Array, words: string, loop_iteration_limit: number, fetch_entry: Function, fetch_chain: Function): Promise<Uint8Array>;
