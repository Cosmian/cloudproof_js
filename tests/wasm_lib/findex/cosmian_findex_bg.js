import * as wasm from './cosmian_findex_bg.wasm';
...
function __wbg_adapter_20(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h79c2eb16ead6d171(arg0, arg1, addHeapObject(arg2));
}
...
*/
export function webassembly_upsert(master_keys, label_bytes, indexed_values_and_words, fetch_entry, upsert_entry, upsert_chain) {
    try {
        ...
        wasm.webassembly_upsert(retptr, ptr0, len0, addHeapObject(label_bytes), ptr1, len1, addHeapObject(fetch_entry), addHeapObject(upsert_entry), addHeapObject(upsert_chain));
...
* @returns {Uint8Array}
*/
export function webassembly_search(master_keys, label_bytes, words, loop_iteration_limit, fetch_entry, fetch_chain) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(master_keys, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        const len1 = WASM_VECTOR_LEN;
        wasm.webassembly_search(retptr, ptr0, len0, addHeapObject(label_bytes), ptr1, len1, loop_iteration_limit, addHeapObject(fetch_entry), addHeapObject(fetch_chain));
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
