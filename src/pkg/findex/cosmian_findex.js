 ...
 */
export function webassembly_upsert(
  search_key,
  update_key,
  label_bytes,
  indexed_values_and_words,
  fetch_entries,
  upsert_entries,
  upsert_chains,
) {
  const ret = wasm.webassembly_upsert(
    addHeapObject(search_key),
    addHeapObject(update_key),
    addHeapObject(label_bytes),
    addHeapObject(indexed_values_and_words),
    addHeapObject(fetch_entries),
    addHeapObject(upsert_entries),
    addHeapObject(upsert_chains),
  )
 ...
 * @returns {Promise<void>}
 */
export function webassembly_graph_upsert(
  search_key,
  update_key,
  label_bytes,
  indexed_values_and_words,
  ...
  const ret = wasm.webassembly_graph_upsert(
    addHeapObject(search_key),
    addHeapObject(update_key),
    addHeapObject(label_bytes),
    addHeapObject(indexed_values_and_words),
 ...
 */
export function webassembly_search(
  search_key,
  label_bytes,
  keywords,
  ...
  const ret = wasm.webassembly_search(
    addHeapObject(search_key),
    addHeapObject(label_bytes),
    addHeapObject(keywords),
    max_results_per_word,
    max_depth,
    addHeapObject(progress),
    addHeapObject(fetch_entries),
    addHeapObject(fetch_chains),
  )
  return takeObject(ret)
}
