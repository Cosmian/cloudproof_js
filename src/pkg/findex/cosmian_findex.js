...
*/
export function webassembly_upsert(search_key, update_key, label_bytes, indexed_values_and_words, fetch_entries, upsert_entries, upsert_chains) {
...
* @returns {Promise<void>}
*/
export function webassembly_graph_upsert(search_key, update_key, label_bytes, indexed_values_and_words, fetch_entries, upsert_entries, upsert_chains) {
...
*/
export function webassembly_search(search_key, label_bytes, keywords, max_results_per_word, max_depth, progress, fetch_entries, fetch_chains) {
