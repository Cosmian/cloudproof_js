...
export function webassembly_upsert(
  search_key: Uint8Array,
  update_key: Uint8Array,
  label_bytes: Uint8Array,
  indexed_values_and_words: Array<{
  ...
  upsert_entries: (
    uidsAndValues: { uid: Uint8Array; value: Uint8Array }[],
  ) => Promise<void>,
  upsert_chains: (
    uidsAndValues: { uid: Uint8Array; value: Uint8Array }[],
  ) => Promise<void>,
...
export function webassembly_search(
  search_key: Uint8Array,
  label_bytes: Uint8Array,
  keywords: Array<Uint8Array>,
  max_results_per_word: number,
  max_depth: number,
  progress: (indexedValues: Uint8Array[]) => Promise<Boolean>,
  fetch_entries: (
    uids: Uint8Array[],
  ) => Promise<{ uid: Uint8Array; value: Uint8Array }[]>,
  fetch_chains: (
...
export interface InitOutput {
  ...
  readonly webassembly_graph_upsert: (
    a: number,
    b: number,
    c: number,
    d: number,
