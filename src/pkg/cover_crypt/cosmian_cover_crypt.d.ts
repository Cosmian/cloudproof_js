 ...
 * @returns {Uint8Array}
 */
export function webassembly_generate_master_keys(
 ...
 * @returns {string}
 */
export function webassembly_rotate_attributes(
 ...
 * @returns {string}
 */
export function webassembly_parse_boolean_access_policy(
...
export interface InitOutput {
  ...
  readonly webassembly_generate_user_secret_key: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly webassembly_rotate_attributes: (
    a: number,
    b: number,
    c: number,
  ) => void
  readonly webassembly_parse_boolean_access_policy: (
    a: number,
    b: number,
    c: number,
  ) => void
  readonly webassembly_encrypt_hybrid_header: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly webassembly_decrypt_hybrid_header: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => void
  readonly webassembly_encrypt_symmetric_block: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => void
  readonly webassembly_decrypt_symmetric_block: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => void
  readonly webassembly_hybrid_encrypt: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly webassembly_hybrid_decrypt: (
    a: number,
    b: number,
    c: number,
    d: number,
