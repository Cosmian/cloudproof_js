 ...
 */
export function deserializeHashMap (serializedItems: Uint8Array): Array<{ uid: Uint8Array, value: Uint8Array }> {
  const leb = require('leb128')
  const items: Array<{
 ...
 * @returns Uint8Array of serialized data
 */
export function serializeHashMap (data: Array<{ uid: Uint8Array, value: Uint8Array }>): Uint8Array {
  const leb = require('leb128')
  let serializedData = new Uint8Array()
