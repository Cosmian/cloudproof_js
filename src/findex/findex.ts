...
export async function Findex() {
   ...
   * @param options.insecureFetchChainsBatchSize increasing this value allow to fetch chains values by batch (less calls to the fetchChains callback to improve performances but also reduce security. Change it at your own risk)
