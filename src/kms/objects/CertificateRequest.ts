...
export class CertificateRequest extends KmipObject {
    ...
    public constructor(certificate_request_type: CertificateRequestType, certificate_request_value: number[]) {
        super()
    ...
    public equals(o: any): boolean {
        ...
        const certificateRequest = o as CertificateRequest
        return this.certificate_request_type === certificateRequest.certificate_request_type
            && this.certificate_request_value === certificateRequest.certificate_request_value
    }

    public toString(): string {
        return "{" + " certificate_request_type='" + this.certificate_request_type + "'"
            + ", certificate_request_value='" + this.certificate_request_value + "'" + "}"
    }
