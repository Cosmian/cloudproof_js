...
export class Decrypt implements KmipStruct {
    ...
    constructor(unique_identifier?: string, cryptographic_parameters?: CryptographicParameters,
        data?: Uint8Array, iv_counter_nonce?: Uint8Array, init_indicator?: boolean,
        final_indicator?: boolean, authenticated_encryption_additional_data?: Uint8Array,
    ...
    public equals(o: any): boolean {
        ...
        return this._unique_identifier === decrypt.unique_identifier
            ...
            && this._authenticated_encryption_tag === decrypt.authenticated_encryption_tag
    }

    public toString(): string {
        return "{" + " unique_identifier='" + this._unique_identifier + "'" + ", cryptographic_parameters='"
            + this._cryptographic_parameters + "'" + ", data='" + this._data + "'" + ", iv_counter_nonce='"
            + this._iv_counter_nonce + "'" + ", init_indicator='" + this._init_indicator + "'" + ", final_indicator='"
            + this._final_indicator + "'" + ", authenticated_encryption_additional_data='"
            + this._authenticated_encryption_additional_data + "'" + ", authenticated_encryption_tag='"
