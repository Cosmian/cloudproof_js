...
export class Locate implements KmipStruct {
    ...
    constructor(attributes: Attributes, maximum_items?: number, offset_items?: number,
        storage_status_mask?: number, object_group_member?: ObjectGroupMember) {
    ...
    public toString(): string {
        return "{" + " maximum_items='" + this._maximum_items + "'" + ", offset_items='" + this._offset_items + "'"
            + ", storage_status_mask='" + this._storage_status_mask + "'" + ", object_group_member='"
            + this._object_group_member + "'" + ", attributes='" + this._attributes + "'" + "}"
    }
