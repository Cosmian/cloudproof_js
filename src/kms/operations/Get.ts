...
export class Get implements KmipStruct {
    ...
    constructor(unique_identifier?: string, key_format_type?: KeyFormatType,
        key_wrap_type?: KeyWrapType, key_compression_type?: KeyCompressionType,
    ...
    public toString(): string {
        return "{" + " unique_identifier='" + this._unique_identifier + "'" + ", key_format_type='"
            + this._key_format_type + "'" + ", key_wrap_type='" + this._key_wrap_type + "'"
            + ", key_compression_type='" + this._key_compression_type + "'" + ", key_wrapping_data='"
